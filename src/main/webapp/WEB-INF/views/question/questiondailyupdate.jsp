			...
			<tbody>
				<tr class="text-c">
					...
					<input type="hidden" name="qdId" value="${qdaily.qdId }">
					 ...
					 <td class="text-l" >
						<u style="cursor:pointer" class="text-primary" title="查看"><input  style="" type="text" class="input-text" value="${qdaily.qdQbid }" placeholder="" id="" name="qdQbid"></u>
					</td>
					
					<td>${qdaily.qdInsid }</td>
					<td class="td-status"><span class="label label-success radius">已发布</span></td>
					<td class="f-14 td-manage"><a style="text-decoration:none" onClick="article_stop(this,'10001')" href="javascript:;" title="下架"><i class="Hui-iconfont">&#xe6de;</i></a> <a style="text-decoration:none" class="ml-5" onClick="article_edit('修改题目','returnPage/toupdateQuestionBnak?qdId=${qdaily.qdId}','10001')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onClick="article_del(this,'${qdaily.qdId }')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
				</tr>
			</tbody>
		</table>
	</div>
