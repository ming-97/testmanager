...
<body>
<div class="pd-20">
	<form action="question/insertQuestion" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>题目内容：</label>
			<div class="formControls col-10">
				<input type="text" class="input-text" value="" placeholder="" id="" name="qbContent">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-2">选项A：</label>
				<div class="formControls col-2"> 
					<input type="text" class="input-text" value="" placeholder="" id="" name="qbOptionsA">
				</div>
		</div>
		<div class="row cl">
			<label class="form-label col-2">选项B：</label>
				<div class="formControls col-2">
					<input type="text" class="input-text" value="" placeholder="" id="" name="qbOptionsB">
				</div>
		</div>
		<div class="row cl">
			<label class="form-label col-2">选项C：</label>
				<div class="formControls col-2"> 
					<input type="text" class="input-text" value="" placeholder="" id="" name="qbOptionsC">
				</div>
		</div>
		<div class="row cl">
			<label class="form-label col-2">选项D：</label>
				<div class="formControls col-2"> 
					<input type="text" class="input-text" value="" placeholder="" id="" name="qbOptionsD">
				</div>
		</div>
		<div class="row cl">
			<label class="form-label col-2">正确答案：</label>
				<div class="formControls col-2"> 
					<input type="text" class="input-text" value="" placeholder="" id="" name="qbAnswer">
				</div>
		</div>
