...
<div class="pd-20">
	...
	<form action="questionCourseManager/insertQuestionCourse" method="post">
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<c:forEach items="${qBnaks }" var="qBank">
				<tr class="text-c">
					...
					<td>${qBank.qbCcid }<input name=qcCid type="hidden" value="${qBank.qbCcid }"></td>
					<td>${qBank.qbInsid }</td>
