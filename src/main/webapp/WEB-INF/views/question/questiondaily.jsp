...
<div class="pd-20">
	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
			<c:forEach items="${questionDaily }" var="qdaily">
				<tr class="text-c">
					<td>${qdaily.qdId }</td>
					<td class="text-l"><u style="cursor:pointer" class="text-primary" onClick="article_edit1('题目详情','questionDailyManager/selectQuestionDailyByNameToPage?qdQbid=${qdaily.qdQbid }','520')" title="查看">${qdaily.qdQbid }</u></td>
					<%-- <td>${qdaily. }</td> --%>
					<td>${qdaily.qdInsid }</td>
					<td>${qdaily.qdCreateBy }</td>
					<td><fmt:formatDate value="${qdaily.qdCreateTime}" pattern="yyyy-MM-dd"/></td>
					<td>${qdaily.qdModifyBy }</td>
					<td><fmt:formatDate value="${qBank.qdModifyTime}" pattern="yyyy-MM-dd"/></td>
					<%-- <td>${qdaily.qbAnswer }</td> --%>
					<%-- <td>${qdaily.qdVersion }</td> --%>
					<td class="td-status"><span class="label label-success radius">已发布</span></td>
					<td class="f-14 td-manage"><a style="text-decoration:none" onClick="article_stop(this,'10001')" href="javascript:;" title="下架"><i class="Hui-iconfont">&#xe6de;</i></a> <a style="text-decoration:none" class="ml-5" onClick="article_edit('修改题目','returnPage/toupdateQuestionDaily?qdId=${qdaily.qdId}','10001')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onClick="article_del(this,'${qdaily.qdId }')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
				</tr>
				</c:forEach>
			</tbody>
		</table>
