		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
				<tr class="text-c">
					...
					<td>${qCourseChapter.qccId }
					<input type="hidden" name="qccId" value="${qCourseChapter.qccId }">
					</td>
					
					 <td class="text-l" >
						<u style="cursor:pointer" class="text-primary" title="查看"><input  style="" type="text" class="input-text" value="${qCourseChapter.qccQbid }" placeholder="" id="" name="qccQbid"></u>
					</td>
					<td>${qCourseChapter.qccInsid }</td>
					<td>${qCourseChapter.qccCcid }
					<input type="hidden" name="qccCcid" value="${qCourseChapter.qccCcid }">
					</td>
