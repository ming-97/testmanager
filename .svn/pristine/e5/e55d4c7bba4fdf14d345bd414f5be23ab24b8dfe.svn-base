...
<div class="loginWraper">
  ...
  <h2 style="text-align: center;">教师登录</h2>
    <form class="form form-horizontal" action="teacherlogin/teacherLogin" method="post">
      <div class="row cl">
        <label class="form-label col-3"><i class="Hui-iconfont">&#xe60d;</i></label>
        <div class="formControls col-8">
          <input id="username" name="tUsername" type="text" placeholder="账户" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-3"><i class="Hui-iconfont">&#xe60e;</i></label>
        <div class="formControls col-8">
          <input id="" name="tPassword" type="password" placeholder="密码" class="input-text size-L">
        </div>
      </div>
      <div class="row">
      ...
      <div class="row">
        <div class="formControls col-8 col-offset-3">
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="studentlogin.jsp">跳转学生登录</a>
        </div>
      </div>
    </form>
  </div>
