					...
					<form action="" method="post">
                                    ...
                                    <input type="hidden" value=" <%=i1=i %>">
										...
										<li id="qu_0_<%=i1 %>">
											<div class="test_content_nr_tt">
												<i><%=i1 %></i><span>(<%=questionType1.getQtGrade()%>分)</span><font>${questionBank1.qbContent}</font><b style="color:red;font-size:18px">(${questionBank1.qbAnswer})</b>
											</div>
							...
							<div class="test_content_nr">
								<ul>
                                    ...
                                    <input type="hidden" value=" <%=j1=j %>">
										<li id="qu_1_<%=j1 %>">
											<div class="test_content_nr_tt">
												<i><%=j1 %></i><span>(<%=questionType2.getQtGrade()%>分)</span><font>${questionBank3.qbContent}</font><b style="color:red;font-size:18px">(${questionBank3.qbAnswer})</b>
											</div>
                        ...
                        <div class="test_content_nr">
                            ...
                            <input type="hidden" value=" <%=k1=k %>">
                                ...
                                <li id="qu_2_<%=k1 %>">
                                    <div class="test_content_nr_tt">
                                        <i><%=k1 %></i><span>(<%=questionType2.getQtGrade()%>分)</span><font>${questionBank2.qbContent}</font><b style="color:red;font-size:18px">(${questionBank2.qbAnswer})</b>
                                    </div>
