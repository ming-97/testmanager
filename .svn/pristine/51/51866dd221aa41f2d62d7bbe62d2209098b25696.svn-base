			...
			<div class="nr_left">
				<div class="test">
					<form action="questionDailyPaper/questionDailyFormInfo" method="post">
						...
						<h1 align="center" style="color:red;text-shadow: 2px 2px 2px black;font-size:30px" >每日一练</h1><br>
						<a style="padding-left:200px;color:blue;font-size:15px">请输入试卷名称唯一标识：</a><input type="text" name="qpName" id="qpName" value="每日一练<%=questionDaily.getQdId() %>"><span id="tip" style="color:red"></span><br/>
                    
						
						<input type="hidden" value="<%=questionDaily.getQdInsid() %>" name="qdInsid" >
                        <input type="hidden" value="<%=questionDaily.getQdId() %>" name="qdId" id="qdId">
							...
							<div class="test_content_nr">
								<ul>
									...
									<input type="hidden" value="${questionBank3.qbId}" name="qpQbId" id="qpQbId">
